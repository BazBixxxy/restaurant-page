...
`, "",{"version":3,"sources":["webpack://./src/header.css"],"names":[],"mappings":"AAAA;EACE,iCAAiC;EACjC,uBAAuB;EACvB,eAAe;EACf,MAAM;EACN,QAAQ;EACR,OAAO;EACP,aAAa;EACb,aAAa;EACb,mBAAmB;EACnB,kBAAkB;EAClB,mBAAmB;EACnB,8CAA8C;EAC9C,YAAY;AACd;;AAEA;EACE,UAAU;EACV,aAAa;EACb,mBAAmB;EACnB,mCAAmC;AACrC;;AAEA;EACE,iBAAiB;EACjB,gBAAgB;EAChB,iBAAiB;EACjB,eAAe;AACjB;;AAEA;EACE,OAAO;AACT;;AAEA;EACE,aAAa;EACb,8BAA8B;AAChC;;AAEA;EACE,gBAAgB;EAChB,eAAe;AACjB;;AAEA;EACE,0BAA0B;AAC5B","sourcesContent":["header {\n  /* background-color: aliceblue; */\n  background-color: white;\n  position: fixed;\n  top: 0;\n  right: 0;\n  left: 0;\n  height: 100px;\n  display: flex;\n  align-items: center;\n  padding-left: 50px;\n  padding-right: 50px;\n  box-shadow: 0px 1px 5px 2px rgb(217, 217, 217);\n  z-index: 100;\n}\n\nheader .left {\n  width: 40%;\n  display: flex;\n  align-items: center;\n  /* justify-content: space-evenly; */\n}\n\n.name {\n  font-size: 1.3rem;\n  font-weight: 400;\n  margin-left: 40px;\n  cursor: pointer;\n}\n\nheader .right {\n  flex: 1;\n}\n\nheader nav {\n  display: flex;\n  justify-content: space-between;\n}\n\nheader nav button {\n  font-weight: 300;\n  font-size: 1rem;\n}\n\nheader nav button:hover {\n  color: hsl(209, 100%, 17%);\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
module.exports = __webpack_require__.p + "f74ee580d4684144e302.jpg";
